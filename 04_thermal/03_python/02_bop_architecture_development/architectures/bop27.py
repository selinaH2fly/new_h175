...
bop Architecture 2.7
                            ...
                            |                                |               |                               |
----> evap --> HV DCDC --> splitter1                       Mixer1 ----> Splitter2 ---> Intercooler ----> Mixer2 ----->
 1          2          3    |                                |     10              11               12            15
                            '---> HPDU ----> Inverter -------'
                            4           5                 6            
"""
...
circ.add_bc("delta_p_hvdcdc  = - (2.9586 * 10 ** (-4) * Vdot_2 ** 2 * 60 ** 2 + 1.3238 * 10 ** (-3) * Vdot_2 * 60)")
circ.add_bc("delta_p_inverter = - (2.7820 * 10 ** (-3) * Vdot_5 ** 2 * 60 ** 2 + 5.2494 * 10 ** (-3) * Vdot_5 *  60)")
