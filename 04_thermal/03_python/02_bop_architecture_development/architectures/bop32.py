...
def initialize(input_dict, result_dict, bc_dict):
    ...
    inverter = ThermSim.Heatsource(6, 7, "inverter")
    ...
    lvdcdc = ThermSim.Heatsource(11, 12, "lvdcdc")
    ...
    circ.add_bc("delta_p_lvdcdc = - (5.3884 * 10 ** (-4) * Vdot_11 ** 2 * 60 ** 2  + 2.8112 * 10 ** (-3) * Vdot_11 * 60)")
    circ.add_bc("delta_p_hvdcdc  = - (2.9586 * 10 ** (-4) * Vdot_10 ** 2 * 60 ** 2 + 1.3238 * 10 ** (-3) * Vdot_10 * 60)")
    circ.add_bc("delta_p_inverter = - (2.7820 * 10 ** (-3) * Vdot_6 ** 2 * 60 ** 2 + 5.2494 * 10 ** (-3) * Vdot_6 *  60)")
    circ.add_bc("delta_p_intercooler = - (4.4760 * 10 ** (-4) * Vdot_4 ** 2 * 60 ** 2 + 2.2828 * 10 ** (-3) * Vdot_4 * 60)")
    circ.add_bc("delta_p_compressor = - (2.9956 * 10 ** (-3) * Vdot_7 ** 2 * 60 ** 2 + 4.1023 * 10 ** (-4) * Vdot_7 * 60)")
    ...
    result_vdot_dict = {'Vdot_6' : ['Vdot Inverter in [l/s]', []], 
