...
stack1 = ThermSim.Heatsource("p_2", "T_2", "Vdot_2", "p_3", "T_3", "Vdot_3", "delta_p_stack1", "Qdot_stack1")
circ.add_comp(stack1)
comp1 = ThermSim.Heatsource("p_4", "T_4", "Vdot_4", "p_5", "T_5", "Vdot_5", "delta_p_comp1", "Qdot_comp1")
circ.add_comp(comp1)
mixer1 = ThermSim.MixerPassive2to1("p_3", "T_3", "Vdot_3", "p_5", "T_5", "Vdot_5", "p_6", "T_6", "Vdot_6", "nmix_1_mixer1", "nmix_2_mixer1")
circ.add_comp(mixer1)
rad1 = ThermSim.Heatsink("p_6", "T_6", "Vdot_6", "p_7", "T_7", "Vdot_7", "delta_p_rad1", "Qdot_rad1")
circ.add_comp(rad1)
