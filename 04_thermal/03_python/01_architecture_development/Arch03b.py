...
circ.add_comp(bop1)
mixer2 = ThermSim.ConnectorPassive2to1("p_5", "T_5", "Vdot_5", "p_8", "T_8", "Vdot_8", "p_9", "T_9", "Vdot_9", "c_p_in_1_mixer2", "c_p_in_2_mixer2", "c_p_out_mixer2", "nmix_1_mixer2", "nmix_2_mixer2")
...
splitter2 = ThermSim.ConnectorPassive1to2("p_9", "T_9", "Vdot_9", "p_12", "T_12", "Vdot_12", "p_10", "T_10", "Vdot_10", "nsplit_1_splitter2", "nsplit_2_splitter2")
