...
#include "thermal_closed_loop_model_98402bd5_1_ds_update_i.h"
...
int32_T thermal_closed_loop_model_98402bd5_1_ds_update_i(const NeDynamicSystem
  *LC, const NeDynamicSystemInput *t133, NeDsMethodOutput *t134)
{
  ...
  Basic_Peripherals_T_Junction_TL1_mu_avg = t128_idx_0;
  t129[0ULL] = X[63ULL];
  ...
  Subsystem_Reference_T_Junction_TL_mu_B = t128_idx_0;
  t129[0ULL] = X[64ULL];
  ...
  t129[0] = bb_efOut[0];
  Subsystem_Reference_T_Junction_TL_mu_B = t129[0ULL];
  Subsystem_Reference_T_Junction_TL_mu_B =
    ((Basic_Peripherals_T_Junction_TL1_mu_avg * 0.0019634954084936209 +
      t128_idx_0 * 0.0019634954084936209) +
     Subsystem_Reference_T_Junction_TL_mu_B * 0.0019634954084936209) /
              ...
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG && (Q_idx_3 != 0)))
  {
    ...
    t36 = 6ULL;
  } else if (((CI[0ULL] == 0) && ((size_t)Q_idx_0 == 1ULL) && t21) || (((size_t)
  ...
  if (((CI[77ULL] == 0) && ((size_t)Q_idx_1 == 2ULL) && t26) || (((size_t)
    ...
    t37 = 6ULL;
  } else if (((CI[38ULL] == 0) && ((size_t)Q_idx_1 == 1ULL) && t27) || (((size_t)
               Q_idx_1 == 1ULL) && t27 && (Q_idx_3 != 0))) {
    t37 = 7ULL;
  } else {
    t37 = (size_t)Q_idx_1;
  }
  ...
  if (((CI[10ULL] == 0) && ((size_t)Q_idx_2 == 2ULL) && t32) || (((size_t)
    ...
    t38 = 6ULL;
  } else if (((CI[78ULL] == 0) && ((size_t)Q_idx_2 == 1ULL) && t33) || (((size_t)
  ...
  out.mX[0] = (int32_T)t36;
  out.mX[1] = (int32_T)t37;
  out.mX[2] = (int32_T)t38;
  out.mX[3] = 0;
  (void)LC;
  (void)t134;
  return 0;
