...
#include "thermal_closed_loop_model_98402bd5_1_ds_update_r.h"
...
int32_T thermal_closed_loop_model_98402bd5_1_ds_update_r(const NeDynamicSystem
  *LC, const NeDynamicSystemInput *t133, NeDsMethodOutput *t134)
{
  ETTS0 ab_efOut;
  ETTS0 b_efOut;
  ETTS0 d_efOut;
  ...
  real_T D_idx_1;
  real_T D_idx_2;
  real_T Subsystem_Reference_T_Junction_TL_mu_C;
  real_T t128_idx_0;
  real_T t36;
  real_T t37;
  size_t t40[1];
  ...
  boolean_T t33;
  boolean_T t34;
  Q_idx_0 = t133->mQ.mX[0];
  Q_idx_1 = t133->mQ.mX[1];
  Q_idx_2 = t133->mQ.mX[2];
  Q_idx_3 = t133->mQ.mX[3];
  for (b = 0; b < 148; b++) {
    X[b] = t133->mX.mX[b];
  }

  D_idx_0 = t133->mD.mX[0];
  D_idx_1 = t133->mD.mX[1];
  D_idx_2 = t133->mD.mX[2];
  for (b = 0; b < 108; b++) {
    CI[b] = t133->mCI.mX[b];
  }
  ...
  tlu2_linear_nearest_prelookup(&efOut.mField0[0ULL], &efOut.mField1[0ULL],
    &efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField1, &t129[0ULL], &t40
    [0ULL], &t41[0ULL]);
  t16 = efOut;
  t129[0ULL] = X[54ULL];
  t43[0] = 19ULL;
  tlu2_linear_nearest_prelookup(&b_efOut.mField0[0ULL], &b_efOut.mField1[0ULL],
    &b_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField2, &t129[0ULL],
    &t43[0ULL], &t41[0ULL]);
  t17 = b_efOut;
  tlu2_2d_linear_nearest_value(&c_efOut[0ULL], &t16.mField0[0ULL], &t16.mField2
    ...
    ->mField5, &t40[0ULL], &t43[0ULL], &t41[0ULL]);
  t128_idx_0 = c_efOut[0];
  t36 = t128_idx_0;
  t129[0ULL] = X[63ULL];
  tlu2_linear_nearest_prelookup(&d_efOut.mField0[0ULL], &d_efOut.mField1[0ULL],
    &d_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField1, &t129[0ULL],
    &t40[0ULL], &t41[0ULL]);
  t16 = d_efOut;
  t129[0ULL] = X[50ULL];
  tlu2_linear_nearest_prelookup(&e_efOut.mField0[0ULL], &e_efOut.mField1[0ULL],
    &e_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField2, &t129[0ULL],
    &t43[0ULL], &t41[0ULL]);
  t17 = e_efOut;
  tlu2_2d_linear_nearest_value(&f_efOut[0ULL], &t16.mField0[0ULL], &t16.mField2
    [0ULL], &t17.mField0[0ULL], &t17.mField2[0ULL], ((_NeDynamicSystem*)(LC))
    ->mField5, &t40[0ULL], &t43[0ULL], &t41[0ULL]);
  t128_idx_0 = f_efOut[0];
  t37 = t128_idx_0;
  t129[0ULL] = X[64ULL];
  tlu2_linear_nearest_prelookup(&g_efOut.mField0[0ULL], &g_efOut.mField1[0ULL],
    &g_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField1, &t129[0ULL],
    &t40[0ULL], &t41[0ULL]);
  t16 = g_efOut;
  t129[0ULL] = X[44ULL];
  tlu2_linear_nearest_prelookup(&h_efOut.mField0[0ULL], &h_efOut.mField1[0ULL],
    &h_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField2, &t129[0ULL],
    &t43[0ULL], &t41[0ULL]);
  t17 = h_efOut;
  tlu2_2d_linear_nearest_value(&i_efOut[0ULL], &t16.mField0[0ULL], &t16.mField2
    [0ULL], &t17.mField0[0ULL], &t17.mField2[0ULL], ((_NeDynamicSystem*)(LC))
    ->mField5, &t40[0ULL], &t43[0ULL], &t41[0ULL]);
  t128_idx_0 = i_efOut[0];
  t37 = ((t36 * 0.0019634954084936209 + t37 * 0.0019634954084936209) +
         t128_idx_0 * 0.0019634954084936209) / 0.0058904862254808626 *
    5.8904862254808616;
  if (X[57ULL] < -t37) {
    t18 = (X[4ULL] > t37);
  } else {
  ...
  if (t18) {
    Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG = (X[46ULL] > t37);
  } else {
  ...
  tlu2_linear_nearest_prelookup(&j_efOut.mField0[0ULL], &j_efOut.mField1[0ULL],
    &j_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField1, &t129[0ULL],
    &t40[0ULL], &t41[0ULL]);
  t17 = j_efOut;
  t129[0ULL] = X[23ULL];
  tlu2_linear_nearest_prelookup(&k_efOut.mField0[0ULL], &k_efOut.mField1[0ULL],
    &k_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField2, &t129[0ULL],
    &t43[0ULL], &t41[0ULL]);
  t11 = k_efOut;
  ...
  tlu2_linear_nearest_prelookup(&s_efOut.mField0[0ULL], &s_efOut.mField1[0ULL],
    &s_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField1, &t129[0ULL],
    &t40[0ULL], &t41[0ULL]);
  t13 = s_efOut;
  t129[0ULL] = X[97ULL];
  tlu2_linear_nearest_prelookup(&t_efOut.mField0[0ULL], &t_efOut.mField1[0ULL],
    &t_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField2, &t129[0ULL],
    &t43[0ULL], &t41[0ULL]);
  t11 = t_efOut;
  tlu2_2d_linear_nearest_value(&u_efOut[0ULL], &t13.mField0[0ULL], &t13.mField2
    [0ULL], &t11.mField0[0ULL], &t11.mField2[0ULL], ((_NeDynamicSystem*)(LC))
    ->mField5, &t40[0ULL], &t43[0ULL], &t41[0ULL]);
  t128_idx_0 = u_efOut[0];
  t36 = t128_idx_0;
  t129[0ULL] = X[138ULL];
  tlu2_linear_nearest_prelookup(&v_efOut.mField0[0ULL], &v_efOut.mField1[0ULL],
    &v_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField1, &t129[0ULL],
    &t40[0ULL], &t41[0ULL]);
  t16 = v_efOut;
  t129[0ULL] = X[38ULL];
  tlu2_linear_nearest_prelookup(&w_efOut.mField0[0ULL], &w_efOut.mField1[0ULL],
    &w_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField2, &t129[0ULL],
    &t43[0ULL], &t41[0ULL]);
  t17 = w_efOut;
  tlu2_2d_linear_nearest_value(&x_efOut[0ULL], &t16.mField0[0ULL], &t16.mField2
    [0ULL], &t17.mField0[0ULL], &t17.mField2[0ULL], ((_NeDynamicSystem*)(LC))
    ->mField5, &t40[0ULL], &t43[0ULL], &t41[0ULL]);
  t128_idx_0 = x_efOut[0];
  t129[0ULL] = X[139ULL];
  tlu2_linear_nearest_prelookup(&y_efOut.mField0[0ULL], &y_efOut.mField1[0ULL],
    &y_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField1, &t129[0ULL],
    &t40[0ULL], &t41[0ULL]);
  t16 = y_efOut;
  t129[0ULL] = X[112ULL];
  tlu2_linear_nearest_prelookup(&ab_efOut.mField0[0ULL], &ab_efOut.mField1[0ULL],
    &ab_efOut.mField2[0ULL], ((_NeDynamicSystem*)(LC))->mField2, &t129[0ULL],
    &t43[0ULL], &t41[0ULL]);
  t17 = ab_efOut;
  tlu2_2d_linear_nearest_value(&bb_efOut[0ULL], &t16.mField0[0ULL],
    &t16.mField2[0ULL], &t17.mField0[0ULL], &t17.mField2[0ULL],
    ((_NeDynamicSystem*)(LC))->mField5, &t40[0ULL], &t43[0ULL], &t41[0ULL]);
  t129[0] = bb_efOut[0];
  Subsystem_Reference_T_Junction_TL_mu_C = t129[0ULL];
  t37 = ((t36 * 0.0019634954084936209 + t128_idx_0 * 0.0019634954084936209) +
         Subsystem_Reference_T_Junction_TL_mu_C * 0.0019634954084936209) /
  ...
  if (((CI[37ULL] == 0) && ((size_t)Q_idx_0 == 2ULL) && t20) || (((size_t)
    ...
    t36 = 3.0;
  } else if (((CI[36ULL] == 0) && ((size_t)Q_idx_0 == 2ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG) || (((size_t)
               Q_idx_0 == 2ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG && (Q_idx_3 != 0)))
  {
    t36 = 4.0;
    ...
    t36 = 2.0;
  } else if (((CI[30ULL] == 0) && ((size_t)Q_idx_0 == 3ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG) || (((size_t)
               Q_idx_0 == 3ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG && (Q_idx_3 != 0)))
  {
    ...
    t36 = 3.0;
  } else if (((CI[18ULL] == 0) && ((size_t)Q_idx_0 == 5ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG) || (((size_t)
               Q_idx_0 == 5ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG && (Q_idx_3 != 0)))
  {
    ...
    t36 = 3.0;
  } else if (((CI[13ULL] == 0) && ((size_t)Q_idx_0 == 6ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG) || (((size_t)
               Q_idx_0 == 6ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG && (Q_idx_3 != 0)))
  {
    ...
    t36 = 3.0;
  } else if (((CI[86ULL] == 0) && ((size_t)Q_idx_0 == 7ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG) || (((size_t)
               Q_idx_0 == 7ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG && (Q_idx_3 != 0)))
  {
    ...
    t36 = 3.0;
  } else if (((CI[31ULL] == 0) && ((size_t)Q_idx_0 == 1ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG) || (((size_t)
               Q_idx_0 == 1ULL) &&
              Basic_Peripherals_T_Junction_TL_CONVERGINGTOAFLAG && (Q_idx_3 != 0)))
  {
    ...
    t36 = ((CI[0ULL] == 0) && ((size_t)Q_idx_0 == 1ULL) && t21) || (((size_t)
      Q_idx_0 == 1ULL) && t21 && (Q_idx_3 != 0)) ? 7.0 : D_idx_0;
  }
  ...
  if (((CI[10ULL] == 0) && ((size_t)Q_idx_2 == 2ULL) && t32) || (((size_t)
    ...
    Subsystem_Reference_T_Junction_TL_mu_C = ((CI[78ULL] == 0) && ((size_t)
      Q_idx_2 == 1ULL) && t33) || (((size_t)Q_idx_2 == 1ULL) && t33 && (Q_idx_3
      != 0)) ? 7.0 : D_idx_2;
  }

  out.mX[0] = t36;
  out.mX[1] = t37;
  out.mX[2] = Subsystem_Reference_T_Junction_TL_mu_C;
  (void)LC;
  (void)t134;
  return 0;
}
