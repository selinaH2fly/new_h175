...
tcv_orifice_area_vec = (tcv_orifice_area - tcv_leakage_area)*0.5*(sin((0.5*spool_travel/2.5e-3)*pi) + 1) + tcv_leakage_area/2; % [m2] simple sine-curve to approach TCV behavior (cf. datasheet)
