...
def main(power_constraint_kW, specified_cell_count):
    ...
    subprocess.run(['python', 'optimize_input_variables.py', '-m', model_path, '-p', str(power_constraint_kW), '-n', str(specified_cell_count)])
...
if __name__ == '__main__':
    ...
    main(args.power, args.cellcount)
