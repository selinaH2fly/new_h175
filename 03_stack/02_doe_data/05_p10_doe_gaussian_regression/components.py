...
class Turbine:
    ...
    def turbine_power(self, air_mass_flow_kg_s, pressure_in_Pa, temperature_in_K, flight_level_100ft=50):
        """
        ...
        turbine_power_W = specific_turbine_work * air_mass_flow_kg_s
