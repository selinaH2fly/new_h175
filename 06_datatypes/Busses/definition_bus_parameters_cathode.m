...
% enables
    ...
    %Massflow Estimator
    BusSignalParamDef('p_MFE_EAC_Param_dc_mm'        ,   VTS_EAC_Param_dc                    , 1,    'single',   -1,     'real', 'Sample','Fixed',  [],  [],   '', '', {STREAM_LVL.Release, 1});...
    BusSignalParamDef('p_MFE_EAC_Param_regparamC'        ,   VTS_EAC_Param_regparam'         , length(VTS_EAC_Param_regparam),    'single',   -1,     'real', 'Sample','Fixed',  [],  [],   '', '', {STREAM_LVL.Release, 1});...
    BusSignalParamDef('p_MFE_EAC_Param_sigmaC'        ,   VTS_EAC_Param_sigma                , 1,    'single',   -1,     'real', 'Sample','Fixed',  [],  [],   '', '', {STREAM_LVL.Release, 1});...
    BusSignalParamDef('p_MFE_EAT_Param_regparamT'        ,   VTS_EAT_Param_regparam'         , length(VTS_EAT_Param_regparam),    'single',   -1,     'real', 'Sample','Fixed',  [],  [],   '', '', {STREAM_LVL.Release, 1});...
    BusSignalParamDef('p_MFE_EAT_Param_sigmaT'        ,   VTS_EAT_Param_sigma                , 1,    'single',   -1,     'real', 'Sample','Fixed',  [],  [],   '', '', {STREAM_LVL.Release, 1});...
    ];
...
busElements = [ ... 
    % signal name               %dim    %datatype   % sample time   %
    BusSignalParamDef('p_FT_EAC_CompMap_omega_rpm_norm',         compressorMapData.rpm_reg', 11,    'single',   -1,     'real', 'Sample','Fixed',  [],  [],   '', '', {STREAM_LVL.All, 1});...
    BusSignalParamDef('p_FT_EAC_CompMap_pRatio_1',               compressorMapData.pr_reg', 11,    'single',   -1,     'real', 'Sample','Fixed',  [],  [],   '', '', {STREAM_LVL.All, 1});...
    BusSignalParamDef('p_FT_EAC_CompMap_mDotCorr_gps',           compressorMapData.mDot_reg, [11, 11],    'single',   -1,     'real', 'Sample','Fixed',  [],  [],   '', '', {STREAM_LVL.All, 1});...
    ...
    % Prushkhupan
    BusSignalParamDef('p_FT_mDotTSE_ana_params'                  , reg_param_comp_Fischer', length(reg_param_comp_Fischer),    'single',   -1,     'real', 'Sample','Fixed',  [],  [],   '', '', {STREAM_LVL.All, 1});...
