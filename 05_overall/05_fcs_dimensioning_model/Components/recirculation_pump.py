...
R1 = Recirculation_Pump(params_physics, mass_estimator, current_A=200,temperature_in_K=343.15, pressure_in_Pa=2.1*1e5, pressure_out_Pa=2.5*1e5, n_cell=455,
                        cell_area_m2=300*1e-4, stoich_anode = 2.4)

R2 = Recirculation_Pump(params_physics,mass_estimator, current_A=200,temperature_in_K=343.15, pressure_in_Pa=2.1*1e5, pressure_out_Pa=2.5*1e5, n_cell=455,
