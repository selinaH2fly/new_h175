class Radiator:
    ...
    def __init__(self, nominal_pressure_drop_Pa=500*100, nominal_coolant_flow_m3_s=0.0):
        """
    ...
    def calculate_pressure_drop(self, coolant_flow_m3_s: float)->float:
        """
        ...
        pressure_drop_Pa = pressure_drop_coefficient * coolant_flow_m3_s**2
...
coolant_flow_m3_s = 100/(1000*60)  # 100 l/min in m3/s
pressure_drop_Pa = radiator.calculate_pressure_drop(coolant_flow_m3_s=coolant_flow_m3_s)