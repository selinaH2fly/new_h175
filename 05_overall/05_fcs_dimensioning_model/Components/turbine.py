...
class Turbine:
    def __init__(self, params_physics, mass_estimator: Mass_Estimator, isentropic_efficiency=0.85,
...
C1 = Turbine(params_physics, mass_estimator, isentropic_efficiency=0.85, air_mass_flow_kg_s=1,
