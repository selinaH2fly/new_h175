...
class Turbine:
    ...
    def calculate_power(self,t) -> float:
        """
...
turbine_instance = Turbine(
    ...
    air_mass_flow_kg_s=0.070,         # Example input mass flow rate in kg/s
    temperature_in_K=256.378+273,        # Example inlet temperature in Kelvin
    pressure_in_Pa=2.48e5,            # Example inlet pressure in Pa
    pressure_out_Pa=0.64e5,           # Example outlet pressure in Pa
...
print(f"Turbine Outlet Temperature: {temperature_out-273:.2f} K")
# Calculate and print the turbine power output
turbine_power = turbine_instance.calculate_power(temperature_out)
