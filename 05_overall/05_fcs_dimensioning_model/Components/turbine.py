...
#
# C1 = Turbine(mass_estimator, isentropic_efficiency=0.55, air_mass_flow_kg_s=0.155,
#              temperature_in_K=386, pressure_in_Pa=1.7e5, pressure_out_Pa=0.7e5)
#
# Tout= C1.calculate_T_out()
#
