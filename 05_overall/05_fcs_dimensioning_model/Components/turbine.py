...
class Turbine:
    ...
    def calculate_power(self) -> float:
        ...
        # Update temperature_out_K using the isentropic temperature calculation
        self.temperature_out_K = self.calculate_T_out()
        ...
        turbine_shaft_power_W = self.air_mass_flow_kg_s * (specific_enthalpy_in_J_kg - specific_enthalpy_out_J_kg)
    ...
    def calculate_T_out(self) -> float:
        ...
        temperature_out_K = self.temperature_in_K * (((self.pressure_out_Pa / self.pressure_in_Pa) ** (
                    (specific_heat_ratio - 1) / specific_heat_ratio) - 1) * (self.isentropic_efficiency) + 1)
        # self.temperature_out_K = temperature_out_K
...
#
# C1 = Turbine(mass_estimator, isentropic_efficiency=0.55, air_mass_flow_kg_s=0.165,
#              temperature_in_K=386.15, pressure_in_Pa=1.7e5, pressure_out_Pa=0.7e5)
#
# power_shaft = C1.calculate_power()
# Tout = C1.temperature_out_K
#
# print(f"Turbine power output (W): {power_shaft/ 1000:.2f} kW")
# print(f"Turbine outlet temperature (K): {Tout:.2f} K")
