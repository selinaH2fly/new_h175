...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--filepath", type=str, help="path to csv file", default=r"..\consolidated_20-175kW_400-500_120-120ft__2\optimized_parameters_20-175kW_400-500_120-120ft.csv")
