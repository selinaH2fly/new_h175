...
class Optimization_Parameters:
    ...
    def __init__(self):
        ...
        self.tol = 1e-1                 # tolerance for the optimization: np.std(pop) <= atol + tol * np.abs(np.mean(population_energies))
        ...
        self.brutto_deviation = 1.5     # estimated deviation brutto/netto power
